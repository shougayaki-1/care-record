            ...
            <Box sx={{ flexGrow: 1, overflowY: 'auto', p: 3 }}>
                <Container maxWidth="sm">
                    ...
                    <Stack spacing={3}>
                        <Paper variant="outlined" sx={{ p: 4, borderRadius: 3, textAlign: 'center' }}>
                            <Box position="relative" display="inline-block" mb={2}>
                                ...
                                <IconButton 
                                    color="primary" 
                                    component="label" 
                                    sx={{ position: 'absolute', bottom: 0, right: -10, bgcolor: 'white', boxShadow: 2, '&:hover': {bgcolor: tokens.neutral.gray150} }}
                                >
                        ...
                        <Paper variant="outlined" sx={{ p: 4, borderRadius: 3, borderColor: 'error.main', bgcolor: tokens.status.error.bg }}>
